class ShoppingCart:
    ...
    def add_item(self, name: str, price: float, quantity: int = 1) -> None:
        ...
        if name in self._items:
            # FIX: Artık miktarı sadece güncellemek yerine mevcut miktara ekliyor
    ...
    def apply_discount(self, code: str) -> None:
        ...
        # FIX: Eşitlik durumu eklendi (min_order sınır değerleri için)
    ...
    def get_total(self) -> float:
        ...
        if self._discount["type"] == "percent":
            # FIX: Tam sayı bölmesi (//) yerine normal bölme (/) kullanıldı
    ...
    def clear(self) -> None:
        self._items = {}
        self._discount = None # FIX: İndirim durumu da sıfırlanıyor

    def get_item_count(self) -> int:
        # FIX: Metot implemente edildi, sepetteki toplam ürün adedini döner
